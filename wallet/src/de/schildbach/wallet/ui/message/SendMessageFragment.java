 ...
 */
public final class SendMessageFragment extends SherlockFragment
    /*
        This class is based off of Schildbach's SendCoinsFragment class.
        The modifications made to that class are most importantly:

        - CurrencyView set uneditable because amount will be determined
        by the content of the message, not by the user.
        - 'Send' now sends multiple transactions instead of one transaction.
     */
{
    ...
    private final class ReceivingAddressActionMode implements ActionMode.Callback
    {
        ...
        public boolean onCreateActionMode(final ActionMode mode, final Menu menu)
        {
            ...
            inflater.inflate(R.menu.send_message_address_context, menu);
        ...
        {
            menu.findItem(R.id.send_message_address_context_clear).setVisible(paymentIntent.mayEditAddress());
        ...
        public boolean onActionItemClicked(final ActionMode mode, final MenuItem item)
        {
            ...
            {
                case R.id.send_message_address_context_edit_address:
                    handleEditAddress();

                    mode.finish();
                    return true;

                case R.id.send_message_address_context_clear:
                    handleClear();
        ...
        public void onConfidenceChanged(final Transaction tx, final TransactionConfidence.Listener.ChangeReason reason)
        {
            activity.runOnUiThread(new Runnable()
            {
                ...
                public void run()
                {
                    ...
                    {
                        // play sound effect
                        final int soundResId = getResources().getIdentifier("send_message_broadcast_" + numBroadcastPeers, "raw",
    ...
    public void onCreate(final Bundle savedInstanceState)
    {
        ...
        else
        {
            ...
            else if (intent.hasExtra(SendMessageActivity.INTENT_EXTRA_PAYMENT_INTENT))
            {
    ...
    {
        final View view = inflater.inflate(R.layout.send_message_fragment, container);

        payeeNameView = (TextView) view.findViewById(R.id.send_message_payee_name);
        payeeOrganizationView = (TextView) view.findViewById(R.id.send_message_payee_organization);
        payeeVerifiedByView = (TextView) view.findViewById(R.id.send_message_payee_verified_by);

        receivingAddressView = (AutoCompleteTextView) view.findViewById(R.id.send_message_receiving_address);
        receivingAddressView.setAdapter(new AutoCompleteAddressAdapter(activity, null));
        receivingAddressView.setOnFocusChangeListener(receivingAddressListener);
        receivingAddressView.addTextChangedListener(receivingAddressListener);

        receivingStaticView = view.findViewById(R.id.send_message_receiving_static);
        receivingStaticAddressView = (TextView) view.findViewById(R.id.send_message_receiving_static_address);
        receivingStaticLabelView = (TextView) view.findViewById(R.id.send_message_receiving_static_label);
        ...
        final CurrencyAmountView btcAmountView = (CurrencyAmountView) view.findViewById(R.id.send_message_amount_btc);
        ...
        txFeeView = (TextView)view.findViewById(R.id.send_message_transaction_fee);

        directPaymentEnableView = (CheckBox) view.findViewById(R.id.send_message_direct_payment_enable);
        ...
        directPaymentMessageView = (TextView) view.findViewById(R.id.send_message_direct_payment_message);
        ...
        viewCancel = (Button) view.findViewById(R.id.send_message_cancel);
        ...
        popupMessageView = (TextView) inflater.inflate(R.layout.send_message_popup_message, container);
    ...
    {
        inflater.inflate(R.menu.send_message_fragment_options, menu);

        scanAction = menu.findItem(R.id.send_message_options_scan);
        emptyAction = menu.findItem(R.id.send_message_options_empty);
    ...
    public boolean onOptionsItemSelected(final MenuItem item)
    {
        switch (item.getItemId())
        {
            case R.id.send_message_options_scan:
                handleScan();
                return true;

            case R.id.send_message_options_empty:
                handleEmpty();
                return true;
        }
    ...
    private void handlePayment(final PaymentIntent paymentIntent, final boolean lastPayment)
    {
        ...
        new SendCoinsOfflineTask(wallet, backgroundHandler)
        {
            ...
            protected void onInsufficientMoney(@Nullable final BigInteger missing)
            {
                ...
                //msg.append(getString(R.string.send_message_fragment_insufficient_money_msg2));
    ...
    {
        final PaymentIntent paymentIntent = extras.getParcelable(SendMessageActivity.INTENT_EXTRA_PAYMENT_INTENT);
    ...
    private void requestPaymentRequest(final String paymentRequestUrl)
    {
        ...
        final RequestPaymentRequestTask.ResultCallback callback = new RequestPaymentRequestTask.ResultCallback()
        {
            ...
            public void onPaymentIntent(final PaymentIntent paymentIntent)
            {
                ...
                if (SendMessageFragment.this.paymentIntent.isExtendedBy(paymentIntent))
                {
                    updateStateFrom(paymentIntent);
                    updateView();
                }
                else
                {
                    ...
                    if (!SendMessageFragment.this.paymentIntent.equalsAddress(paymentIntent))
                        reasons.append("address");
                    if (!SendMessageFragment.this.paymentIntent.equalsAmount(paymentIntent))
